...
"https://los-n-found.onrender.com/api/found",
...
<div className={`${isDarkMode?"bg-green-900 text-green-200":"bg-green-100 text-green-800"} p-4 rounded-lg mb-4 text-center`}>
